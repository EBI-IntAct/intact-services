...
<div id="display_query_box_div" class="divformat" style="display:block">
	...
	<table width="500" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td>Protein ID:&nbsp;<input id="feature_id_box" class="textbox" style="width: 80px;" name="feature_id_box" type="text" value=""/>&nbsp;&nbsp;&nbsp;&nbsp;<span id="feature_label_list"></span>&nbsp;<input name="send_query" type="submit" id="send_query" value="Go" onClick="newid('feature_id_box', 'feature_label_list_select')" /></td>
      </tr>
    </table>
	<br />
	<a style="text-decoration: none;" href="http://www.dasregistry.org/help_coordsys.jsp" target="_blank"><img src="img/info01.gif" border="0" /></a> &quot;<a href="http://www.dasregistry.org/coordsys/CS_DS6">UniProt</a>&quot; protein sequence <a href="http://www.dasregistry.org/help_coordsys.jsp">coordinate system</a>
    <br />&nbsp;<br />
...
<div id="display_checking_div" class="divformat" style="display:block">
	...
	<table width="400" border="0" cellpadding="0" cellspacing="0">
  	<tr>
   	    <td width="15"  valign="top">
			<span style="display:block; border-bottom: 1px solid #000000; font-weight:bold; color:#222222; margin-bottom: 3px;">
				<a style="text-decoration:none;" href="javascript:changeDisplayState('display_server_checking_div', 'menu_server_checking_img', 1)">
					...
					Annotation servers loaded:				</a>			</span>
			<div id="progress_bar_empty" style="background-color:#F0F0F0;border:1px solid #999999;height:12px;width:300px;padding:0px;" align="left">
		...
		<td valign="top">
			<div style="margin-top:10px;"><input type="button" name="cancel_button" id="cancel_button" value="Cancel" onClick="stop()"/></div>	    </td>
	</tr>
    <tr>	
        <td colspan="3" valign="top">	    
			<span style="display:block; border-bottom: 1px solid #000000; font-weight:bold; color:#222222; margin-bottom: 5px; margin-top:15px;">
